...
const content = fs.readFileSync('./test/html/hydex.html', 'utf8')

chai.should()

describe('현대택배', () => {
  const invoice = parser.hydex(trackingCode, content)
  ...
  it('InvoiceHistory > 배달중', () => {
    ...
    history[6].remark.should.equal('고객님께 배달 준비중 입니다.')
  ...
  it('InvoiceHistory > 배달완료', () => {
    ...
    history[7].remark.should.equal('배달 완료하였습니다.')
